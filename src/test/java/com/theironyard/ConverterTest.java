...
public class ConverterTest extends TestifierTest{
    ...
    public void testConvert(double length, String fromUnitName, double expected, String toUnitName) {
        ...
        } catch (MethodIsNotStaticException | CannotInvokeMethodException | ClassNotFoundException | CannotFindMethodException | CannotAccessMethodException | CannotFindEnumException e) {
